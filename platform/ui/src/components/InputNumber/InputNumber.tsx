...
const InputNumber: React.FC<{
  ...
  return (
    <div
      className={`flex items-center bg-white border-2 px-1 overflow-hidden justify-center border-secondary-light rounded-md ${sizesClasses[size]
        } ${className ? className : ''}`}
    >
      <div className="flex">
        <input
          ...
          className={`bg-white text-black text-[12px] w-full text-center input-number`}
        />
