      ...
      <tr className="select-none">
        <td
          className={classnames('border-0 p-0', {
            'border-b border-secondary-light bg-common-main': isExpanded,
          })}
        >
          <div
          ...
          >
            <table className={classnames('w-full p-4')}>
              <tbody>
                <tr
                  className={classnames(
                    'cursor-pointer hover:bg-common-bright transition duration-300',
                    {
                      'bg-primary-w': !isExpanded,
                    },
                    { 'bg-common-bright': isExpanded }
                  )}
                  onClick={onClickRow}
                >
                  {row.map((cell, index) => {
                ...
                {isExpanded && (
                  <tr className="w-full bg-white select-text max-h-0 overflow-hidden">
